...
(
python parser.py train ${mod0} ${args} -l 0.01 -B 1 --gpu ${gpu} -w 32 -D 0.2 -K 0 -s 10 > ${mod0}/log.txt 2> ${mod0}/err.txt &&
...
(
python parser.py train ${mod1} ${args} -l 0.01 -B 1 --gpu ${gpu} -w 32 -D 0.2 -K 0 --dyno 0.15 -s 10 > ${mod1}/log.txt 2> ${mod1}/err.txt &&
